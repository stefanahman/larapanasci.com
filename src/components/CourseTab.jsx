    ...
    >
      <div className="container">
        <div className="lg:text-left lg:space-x-6 text-center md:space-x-2">
            <a href="#" class="inline-block text-art-1 pl-6 pr-14 py-4 mb-4 hover:duration-500 border-[7px] hover:bg-[#F5E2C4] border-[#F5E2C4] rounded-full bg-white"><i class="fa-regular fa-calendar-days text-art-1"></i>&#160;&#160;<strong>Duration</strong> 4 week</a>
            <a href="#" class="inline-block text-art-1 pl-6 pr-14 py-4 mb-4 hover:duration-500 border-[7px] hover:bg-[#F5E2C4] border-[#F5E2C4] rounded-full bg-white"><i class="fa-regular fa-calendar-days text-art-1"></i>&#160;&#160;<strong>Duration</strong> 4 week</a>
            <a href="#" class="inline-block text-art-1 pl-6 pr-14 py-4 mb-4 hover:duration-500 border-[7px] hover:bg-[#F5E2C4] border-[#F5E2C4] rounded-full bg-white"><i class="fa-regular fa-calendar-days text-art-1"></i>&#160;&#160;<strong>Duration</strong> 4 week</a>
        </div>
        <div class="lg:text-left lg:space-x-6 text-center md:space-x-2 mb-10">
            <a href="#" class="inline-block text-art-1 pl-6 pr-14 py-4 mb-4 hover:duration-500 border-[7px] hover:bg-[#F5E2C4] border-[#F5E2C4] rounded-full bg-white"><i class="fa-regular fa-calendar-days text-art-1"></i>&#160;&#160;<strong>Duration</strong> 4 week</a>
            <a href="#" class="inline-block text-art-1 pl-6 pr-14 py-4 mb-4 hover:duration-500 border-[7px] hover:bg-[#F5E2C4] border-[#F5E2C4] rounded-full bg-white"><i class="fa-regular fa-calendar-days text-art-1"></i>&#160;&#160;<strong>Duration</strong> 4 week</a>
            <a href="#" class="inline-block text-art-1 pl-6 pr-14 py-4 hover:duration-500 border-[7px] hover:bg-[#F5E2C4] border-[#F5E2C4] rounded-full bg-white"><i class="fa-regular fa-calendar-days text-art-1"></i>&#160;&#160;<strong>Duration</strong> 4 week</a>
        </div>
