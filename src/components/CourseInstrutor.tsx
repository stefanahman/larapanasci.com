    ...
    <section style={{ backgroundImage: `url(${circle44})` }} className="bg-cream px-4 pb-14 md:pb-16 lg:pb-24 bg-right-top bg-no-repeat bg-10">
      <div className="container lg:text-left text-center">
        ...
        <div className="lg:flex text-left lg:space-x-20">
          <div className="lg:mb-0 mb-8 bg-white rounded-3xl">
            <div>
              <Link to="/coursedetails">
                <img className="rounded-tl-3xl rounded-tr-3xl" src={Img1} alt="c-1" /></Link>
              <Link to="/coursedetails" className="relative bottom-4 left-4 text-sm px-4 border border-c-d-cream rounded-full text-c-d-cream py-2 bg-c-d-bg inline-block"><span className="text-art-1  font-semibold">$66</span>&#160;&#160;|&#160;&#160;06 Lessons</Link>
            </div>
            <div className="pt-1 px-5 py-6 flex justify-between">
              <div>
                <Link to="/coursedetails" className="text-sm text-art-1 pb-1">WithJulie Wagner</Link>
                <Link to="/coursedetails" className="w-75"><h3>Yoga for Beginners...</h3></Link>
              </div>
              <div className="pt-1">
          ...
          <div className="lg:mb-0 mb-8 bg-white rounded-3xl">
            <div>
              <Link to="/coursedetails"><img className="rounded-tl-3xl rounded-tr-3xl" src={Img2} alt="c-1" /></Link>
              <Link to="/coursedetails" className="relative bottom-4 left-4 text-sm px-4 border border-c-d-cream rounded-full text-c-d-cream py-2 bg-c-d-bg inline-block"><span className="text-art-1  font-semibold">$66</span>&#160;&#160;|&#160;&#160;06 Lessons</Link>
            </div>
            <div className="pt-1 px-5 py-6 flex justify-between">
              <div>
          ...
          <div className="bg-white rounded-3xl">
            <div>
              <Link to="/coursedetails"><img className="rounded-tl-3xl rounded-tr-3xl" src={Img3} alt="c-1" /></Link>
              <Link to="/coursedetails" className="relative bottom-4 left-4 text-sm px-4 border border-c-d-cream rounded-full text-c-d-cream py-2 bg-c-d-bg inline-block"><span className="text-art-1  font-semibold">$66</span>&#160;&#160;|&#160;&#160;06 Lessons</Link>
            </div>
            <div className="pt-1 px-5 py-6 flex justify-between">
              <div>
